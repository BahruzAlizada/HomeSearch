        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsDeactvie = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlourNumber = table.Column<int>(type: "int", nullable: true),
                    IsNewBuilding = table.Column<bool>(type: "bit", nullable: true),
                    ...
                    IsDeactive = table.Column<bool>(type: "bit", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PremiumDeadLine = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Homes_Repairs_RepairId",
                        column: x => x.RepairId,
                        principalTable: "Repairs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Homes_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Homes_Typees_TypeeId",
                        column: x => x.TypeeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Homes_RepairId",
                table: "Homes",
                column: "RepairId");

            migrationBuilder.CreateIndex(
                name: "IX_Homes_RoomId",
                table: "Homes",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_Homes_TypeeId",
                table: "Homes",
                column: "TypeeId");
        }
